            ...
            <div class="team-layout-1">       
                ...
                <figure class="team-member">
                    <a href="#" title="ALEXANDER GARY">
                        <img src="<?php echo base_url('/') ?>tools/images/team_9.jpg" alt="ALEXANDER GARY"/>
                    </a>
            ...
            <div class="team-layout-1">       
                ...
                <figure class="team-member">
                    <a href="#" title="MELISSA MUNOZ">
                        <img src="<?php echo base_url('/') ?>tools/images/team_6.jpg" alt="MELISSA MUNOZ" />
                    </a>
            ...
            <div class="team-layout-1">       
                ...
                <figure class="team-member">
                    <a href="#" title="JOHN ABRAHAM">
                        <img src="<?php echo base_url('/') ?>tools/images/team_7.jpg" alt="JOHN ABRAHAM" />
                    </a>                               
    ...
    <div class="row">
        ...
        <div class="logo-items logo-layout-1 text-center">
            ...
            <div class="client-logo">
                ...
                <img src="<?php echo base_url('/') ?>tools/images/logo_1.jpg" alt="" />

            </div>

            <div class="client-logo">

                <img src="<?php echo base_url('/') ?>tools/images/logo_2.jpg" alt="" />
            ...
            <div class="client-logo">
                ...
                <img src="<?php echo base_url('/') ?>tools/images/logo_3.jpg" alt="" />
            ...
            <div class="client-logo">
                ...
                <img src="<?php echo base_url('/') ?>tools/images/logo_4.jpg" alt="" />

            </div>

            <div class="client-logo">

                <img src="<?php echo base_url('/') ?>tools/images/logo_5.jpg" alt="" />
            ...
            <div class="client-logo">
                ...
                <img src="<?php echo base_url('/') ?>tools/images/logo_6.jpg" alt="" />

            </div>

            <div class="client-logo">

                <img src="<?php echo base_url('/') ?>tools/images/logo_7.jpg" alt="" />

            </div>

            <div class="client-logo">

                <img src="<?php echo base_url('/') ?>tools/images/logo_8.jpg" alt="" />
